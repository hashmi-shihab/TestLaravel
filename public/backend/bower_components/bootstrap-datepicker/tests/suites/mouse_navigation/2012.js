...
test('Navigating to/from year publicView', function(){
    var target;
...
test('Navigating to/from decade publicView', function(){
    var target;
...
test('Navigating prev/next in year publicView', function(){
    var target;
...
test('Navigating prev/next in decade publicView', function(){
    var target;
