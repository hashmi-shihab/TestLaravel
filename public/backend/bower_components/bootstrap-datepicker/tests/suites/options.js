...
test('Startview: year publicView (integer)', function(){
    var input = $('<input />')
                .appendTo('#qunit-fixture')
                .val('2012-03-05')
                .datepicker({
    ...
    input.focus();
    ok(picker.find('.datepicker-days').is(':not(:visible)'), 'Days publicView hidden');
    ok(picker.find('.datepicker-months').is(':visible'), 'Months publicView visible');
    ok(picker.find('.datepicker-years').is(':not(:visible)'), 'Years publicView hidden');
    ok(picker.find('.datepicker-decades').is(':not(:visible)'), 'Decades publicView hidden');
    ok(picker.find('.datepicker-centuries').is(':not(:visible)'), 'Centuries publicView hidden');
});

test('Startview: year publicView (string)', function(){
    var input = $('<input />')
                .appendTo('#qunit-fixture')
                .val('2012-03-05')
                .datepicker({
...
test('Startview: decade publicView (integer)', function(){
    var input = $('<input />')
                .appendTo('#qunit-fixture')
                .val('2012-03-05')
                .datepicker({
    ...
    input.focus();
    ok(picker.find('.datepicker-days').is(':not(:visible)'), 'Days publicView hidden');
    ok(picker.find('.datepicker-months').is(':not(:visible)'), 'Months publicView hidden');
    ok(picker.find('.datepicker-years').is(':visible'), 'Years publicView visible');
    ok(picker.find('.datepicker-decades').is(':not(:visible)'), 'Decades publicView hidden');
    ok(picker.find('.datepicker-centuries').is(':not(:visible)'), 'Centuries publicView hidden');
});

test('Startview: decade publicView (string)', function(){
    var input = $('<input />')
                .appendTo('#qunit-fixture')
                .val('2012-03-05')
                .datepicker({
...
test('Startview: century publicView (integer)', function(){
    var input = $('<input />')
                .appendTo('#qunit-fixture')
                .val('2012-03-05')
                .datepicker({
    ...
    ok(picker.find('.datepicker-months').is(':not(:visible)'), 'Months publicView hidden');
    ok(picker.find('.datepicker-years').is(':not(:visible)'), 'Years publicView hidden');
    ok(picker.find('.datepicker-decades').is(':visible'), 'Decades publicView visible');
    ok(picker.find('.datepicker-centuries').is(':not(:visible)'), 'Centuries publicView hidden');
});

test('Startview: century publicView (string)', function(){
    var input = $('<input />')
                .appendTo('#qunit-fixture')
                .val('2012-03-05')
                .datepicker({
...
test('Startview: millennium publicView (integer)', function(){
    var input = $('<input />')
                .appendTo('#qunit-fixture')
                .val('2012-03-05')
                .datepicker({
    ...
    ok(picker.find('.datepicker-years').is(':not(:visible)'), 'Years publicView hidden');
    ok(picker.find('.datepicker-decades').is(':not(:visible)'), 'Decades publicView hidden');
    ok(picker.find('.datepicker-centuries').is(':visible'), 'Centuries publicView visible');
});

test('Startview: millennium publicView (string)', function(){
    var input = $('<input />')
                .appendTo('#qunit-fixture')
                .val('2012-03-05')
                .datepicker({
...
test('Today Button: today button not default', function(){
    ...
    input.focus();
    ok(picker.find('.datepicker-days').is(':visible'), 'Days publicView visible');
...
test('Today Button: moves to days publicView', function(){
...
test('Startview: year publicView visible after date pick', function(){
    var input = $('<input />')
            .appendTo('#qunit-fixture')
            .datepicker({
                startView: 2,
...
test('Week Days: Week days default visibility (or enabled)', function(){
    ...
    input.focus();
    ok(picker.find('.dow').length > 0, 'Week days added to publicView');
});
test('Week Days: Week days visibility when disabled', function(){
    ...
    input.focus();
    ok(picker.find('.dow').length === 0, 'Week days not added to publicView');
});
