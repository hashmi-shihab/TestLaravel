...
test('Selecting a year from decade publicView triggers changeYear', function(){
    var target,
        triggered = 0;
...
test('Navigating forward/backward from month publicView triggers changeYear', function(){
    var target,
        triggered = 0;
...
test('Selecting a month from year publicView triggers changeMonth', function(){
    var target,
        triggered = 0;
...
test('Navigating forward/backward from month publicView triggers changeMonth', function(){
    var target,
        triggered = 0;
...
test('Clear button: triggers change and changeDate events', function(){
    ...
    this.input.focus();
    ok(this.picker.find('.datepicker-days').is(':visible'), 'Days publicView visible');
...
test('Changing publicView mode triggers changeViewMode', function () {
  var viewMode = -1,
    triggered = 0;
