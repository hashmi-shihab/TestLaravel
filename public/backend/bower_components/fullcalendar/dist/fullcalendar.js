...
var InteractiveDateComponent = /** @class */ (function (_super) {
    ...
    // Sets the container element that the publicView should render inside of, does global DOM-related initializations,
    ...
    // is it allowed, in relation to the publicView's validRange?
...
var View = /** @class */ (function (_super) {
    ...
    ------------------------------------------------------------------------------------------------------------------*/
    // Computes what the title at the top of the calendar should be for this publicView
    ...
    // Misc publicView rendering utils
    // -----------------------------------------------------------------------------------------------------------------
    // Binds DOM handlers to elements that reside outside the publicView container, such as the document
    ...
    // Unbinds DOM handlers from elements that reside outside the publicView container
    ...
    // Immediately unrenders the publicView's current time indicator and stops any re-rendering timers.
    ...
    /* Event Resizing
    ------------------------------------------------------------------------------------------------------------------*/
    // Must be called when an event in the publicView has been resized to a new length
    ...
    ------------------------------------------------------------------------------------------------------------------*/
    // Selects a date span on the publicView. `start` and `end` are both Moments.
    ...
    View.prototype.renderSelectionFootprint = function (footprint) {
        if (this['renderSelection']) { // legacy method in custom publicView classes
...
var DateProfileGenerator = /** @class */ (function () {
    ...
    ------------------------------------------------------------------------------------------------------------------*/
    // Builds a structure with info about what the dates/ranges will be for the "prev" publicView.
    ...
    // Builds a structure with info about what the dates/ranges will be for the "next" publicView.
    ...
    DateProfileGenerator.prototype.build = function (date, direction, forceToValid) {
        ...
        return {
            ...
            // range the publicView is formally responsible for.
            // for example, a month publicView might have 1st-31st, excluding padded dates
    ...
    DateProfileGenerator.prototype.buildRangeFromDuration = function (date, direction, duration, unit) {
        ...
        // if the publicView displays a single day or smaller
...
var DayGrid = /** @class */ (function (_super) {
    ...
    function DayGrid(view) {
        ...
        // Relies on the publicView's colCnt and rowCnt. In the future, this component should probably be self-sufficient.
        _this.isRigid = false;
    ...
    DayGrid.prototype.renderMoreLink = function (row, col, hiddenSegs) {
        ...
        return $('<a class="fc-more"/>')
            ...
            else if (typeof clickOption === 'string') { // a publicView name
...
var BasicViewDateProfileGenerator_1 = __webpack_require__(68);
var DayGrid_1 = __webpack_require__(66);
/* An abstract class for the "basic" views, as well as month publicView. Renders one or more rows of day cells.
----------------------------------------------------------------------------------------------------------------------*/
...
var BasicView = /** @class */ (function (_super) {
    ...
    // Generates the DayGrid object this publicView needs. Draws from this.dayGridClass
    ...
    BasicView.prototype.renderSkeleton = function () {
        ...
        var dayGridEl;
        this.el.addClass('fc-basic-publicView').html(this.renderSkeletonHtml());
    ...
    // Builds the HTML skeleton for the publicView.
    ...
    /* Dimensions
    ------------------------------------------------------------------------------------------------------------------*/
    // Refreshes the horizontal dimensions of the publicView
    BasicView.prototype.updateSize = function (totalHeight, isAuto, isResize) {
        var eventLimit = this.opt('eventLimit');
        var headRowEl = this.dayGrid.headContainerEl.find('.fc-row');
        var scrollerHeight;
        var scrollbarWidths;
        // hack to give the publicView some height prior to dayGrid's columns being rendered
    ...
    // given a desired total height of the publicView, returns what the height of the scroller should be
    BasicView.prototype.computeScrollerHeight = function (totalHeight) {
        return totalHeight -
            util_1.subtractInnerElHeight(this.el, this.scroller.el); // everything that's NOT the scroller
    };
    // Sets the height of just the DayGrid component in this publicView
...
var Constraints = /** @class */ (function () {
    ...
    */
    ...
    // uses current publicView's range
...
var BusinessHourGenerator = /** @class */ (function () {
    ...
    BusinessHourGenerator.prototype.buildEventInstanceGroup = function (isAllDay, unzonedRange) {
        ...
        if (eventDefs.length) {
            ...
            // so that inverse-background rendering can happen even when no eventRanges in publicView
...
var Popover = /** @class */ (function () {
    ...
    Popover.prototype.position = function () {
        ...
        // constrain to the publicView port. if constrained by two edges, give precedence to top/left
...
var Component = /** @class */ (function (_super) {
    ...
    */
    // Renders the basic structure of the publicView before any content is rendered
    Component.prototype.renderSkeleton = function () {
        // subclasses should implement
    };
    // Unrenders the basic structure of the publicView
...
var DateComponent = /** @class */ (function (_super) {
    ...
    // Generates HTML for an anchor to another publicView into the calendar.
    // Will either generate an <a> tag or a non-clickable <span> tag, depending on enabled settings.
    // `gotoOptions` can either be a moment input, or an object with the form:
    // { date, type, forceOff }
    // `type` is a publicView-type like "day" or "week". default value is "day".
...
var Calendar = /** @class */ (function () {
    ...
    // View
    // -----------------------------------------------------------------------------------------------------------------
    // Given a publicView name for a custom publicView or a standard publicView, creates a ready-to-go View object
    ...
    // Returns a boolean about whether the publicView is okay to instantiate at some point
    ...
    // Forces navigation to a publicView for the given date.
    // `viewType` can be a specific publicView name or a generic one like "week" or "day".
    ...
    Calendar.prototype.initialRender = function () {
        ...
        this.contentEl = $("<div class='fc-publicView-container'/>").prependTo(el);
        this.initToolbars();
        this.renderHeader();
        this.renderFooter();
    ...
    Calendar.prototype.bindViewHandlers = function (view) {
        ...
        view.watch('dateProfileForCalendar', ['dateProfile'], function (deps) {
            if (view === _this.view) { // hack
                _this.currentDate = deps.dateProfile.date; // might have been constrained by publicView dates
    ...
    // View Rendering
    // -----------------------------------------------------------------------------------
    // Renders a publicView because of a date change, publicView-type change, or for the first time.
    // If not given a viewType, keep the current publicView but render different dates.
    ...
    Calendar.prototype.renderView = function (viewType) {
        ...
        // if viewType changed, or the publicView was never created, create a fresh publicView
        if (!this.view && viewType) {
            ...
            newView.setElement($("<div class='fc-publicView fc-" + viewType + "-publicView' />").appendTo(this.contentEl));
    ...
    // Unrenders the current publicView and reflects this change in the Header.
    // Unregsiters the `publicView`, but does not remove from viewByType hash.
    ...
    // Destroys the publicView, including the publicView object. Then, re-instantiates it and renders it.
...
var EventDragging = /** @class */ (function (_super) {
    ...
    */
    ...
    EventDragging.prototype.buildDragListener = function (seg) {
        ...
        // Tracks mouse movement over the *publicView's* coordinate map. Allows dragging and dropping between subcomponents
        // of the publicView.
        var dragListener = this.dragListener = new HitDragListener_1.default(view, {
            ...
            interactionStart: function (ev) {
                ...
                mouseFollower = new MouseFollower_1.default(seg.el, {
                    ...
                    zIndex: 2 // one above the .fc-publicView
                });
...
var AgendaView = /** @class */ (function (_super) {
    ...
    function AgendaView(calendar, viewSpec) {
        ...
        if (_this.opt('allDaySlot')) { // should we display the "all-day" area?
            _this.dayGrid = _this.instantiateDayGrid(); // the all-day subcomponent of this publicView
            _this.addChild(_this.dayGrid);
        }
        _this.scroller = new Scroller_1.default({
            overflowX: 'hidden',
    ...
    // Instantiates the TimeGrid object this publicView needs. Draws from this.timeGridClass
    AgendaView.prototype.instantiateTimeGrid = function () {
        var timeGrid = new this.timeGridClass(this);
        util_1.copyOwnProps(agendaTimeGridMethods, timeGrid);
        return timeGrid;
    };
    // Instantiates the DayGrid object this publicView might need. Draws from this.dayGridClass
    ...
    AgendaView.prototype.renderSkeleton = function () {
        var timeGridWrapEl;
        var timeGridEl;
        this.el.addClass('fc-agenda-publicView').html(this.renderSkeletonHtml());
        this.scroller.render();
    ...
    /* Dimensions
    ------------------------------------------------------------------------------------------------------------------*/
    // Adjusts the vertical dimensions of the publicView to the specified values
    AgendaView.prototype.updateSize = function (totalHeight, isAuto, isResize) {
        ...
        // hack to give the publicView some height prior to timeGrid's columns being rendered
...
var TimeGrid = /** @class */ (function (_super) {
    ...
    TimeGrid.prototype.renderSlatRowHtml = function () {
        ...
        var slotDate; // will be on the publicView's first day, but we only care about its time
        var isLabeled;
        var axisHtml;
    ...
    /* Content Skeleton
    ------------------------------------------------------------------------------------------------------------------*/
    // Renders the DOM that the publicView's content will live in
    ...
    TimeGrid.prototype.renderNowIndicator = function (date) {
        ...
        if (segs.length > 0) { // is the current time in publicView?
...
var BasicView_1 = __webpack_require__(67);
var MonthViewDateProfileGenerator_1 = __webpack_require__(247);
/* A month publicView with day cells running in rows (one-per-week) and columns
----------------------------------------------------------------------------------------------------------------------*/
...
var ListView = /** @class */ (function (_super) {
    ...
    ListView.prototype.renderSkeleton = function () {
        this.el.addClass('fc-list-publicView ' +
    ...
    // render the event segments in the publicView
...
var OptionsManager = /** @class */ (function (_super) {
    ...
    OptionsManager.prototype.add = function (newOptionHash) {
        ...
        // catch-all. rerender the header and footer and rebuild/rerender the current publicView
...
var ViewSpecManager = /** @class */ (function () {
    ...
    // Gets information about how to create a publicView. Will use a cache.
    ViewSpecManager.prototype.getViewSpec = function (viewType) {
        var cache = this.viewSpecCache;
        return cache[viewType] || (cache[viewType] = this.buildViewSpec(viewType));
    };
    // Given a duration singular unit, like "week" or "day", finds a matching publicView spec.
    ...
    // Builds an object with information on how to create a given publicView
    ViewSpecManager.prototype.buildViewSpec = function (requestedViewType) {
        var viewOverrides = this.optionsManager.overrides.views || {};
        var specChain = []; // for the publicView. lowest to highest priority
        var defaultsChain = []; // for the publicView. lowest to highest priority
        var overridesChain = []; // for the publicView. lowest to highest priority
        var viewType = requestedViewType;
        var spec; // for the publicView
        var overrides; // for the publicView
        var durationInput;
        var duration;
        var unit;
        // iterate from the specific publicView definition to a more general one until we hit an actual View class
        while (viewType) {
            ...
            if (overrides) {
                overridesChain.unshift(overrides); // publicView-specific option hashes have options at zero-level
        ...
        if (durationInput) {
            ...
            if (duration.valueOf()) { // valid?
                ...
                // publicView is a single-unit duration, like "week" or "day"
    ...
    // Builds and assigns a publicView spec's options object from its already-assigned defaults and overrides
    ...
    // Computes and assigns a publicView spec's buttonText-related options
    ViewSpecManager.prototype.buildViewSpecButtonText = function (spec, requestedViewType) {
        var optionsManager = this.optionsManager;
        // given an options object with a possible `buttonText` hash, lookup the buttonText for the
        // requested publicView, falling back to a generic unit entry like "week" or "day"
        function queryButtonText(options) {
            var buttonText = options.buttonText || {};
            return buttonText[requestedViewType] ||
                // publicView can decide to look up a certain key
        ...
        spec.buttonTextOverride =
            queryButtonText(optionsManager.dynamicOverrides) ||
                ...
                spec.overrides.buttonText; // `buttonText` for publicView-specific options is a string
        ...
        spec.buttonTextDefault =
            queryButtonText(optionsManager.localeDefaults) ||
                ...
                requestedViewType; // fall back to given publicView name
    };
...
Bootstrap3Theme.prototype.classes = {
    ...
    // day grid
    // for left/right border color when border is inset from edges (all-day in agenda publicView)
