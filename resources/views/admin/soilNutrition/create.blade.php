            ...
            <div class="col-md-6">
                ...
                <div class="box box-primary">
                    <div class="box-header with-border" style="text-align: center">
                        <h3 class="box-title">Soil Nutrition Create</h3>
                        @if(count($errors)>0)
                    ...
                    <!-- /.box-header -->
                    <!-- form start -->
                    <form role="form" method="Post" action="{{route('soilNutrition.store')}}">
                        @csrf
                        @method('POST')
                        <div class="box-body">
                            ...
                            <div class="form-group">
                                ...
                                <input type="" class="form-control" name="sulfur" placeholder="Enter Sulfur">
                            </div>
                            <div class="form-group">
